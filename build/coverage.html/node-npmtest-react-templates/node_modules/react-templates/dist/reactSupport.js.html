...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-templates/node_modules/react-templates/dist/reactSupport.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-templates/node_modules/react-templates/dist/reactSupport.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-templates/node_modules/react-templates/dist/</a> &#187; reactSupport.js</div>
</div>
<div class="body">
 ...
 * @return {boolean}
 */
<span class="fstat-no" title="function not covered" >function shouldUseCreateElement(context) {</span>
<span class="cstat-no" title="statement not covered" >    switch (context.options.targetVersion) {</span>
        case '0.11.2':
        case '0.11.1':
        case '0.11.0':
        case '0.10.0':
...
&nbsp;
var buildImportTypeScript = _.cond([[isImportAsterisk, <span class="fstat-no" title="function not covered" >function (d) {</span>
<span class="cstat-no" title="statement not covered" >    return 'import ' + d.alias + ' = require(\'' + d.moduleName + '\');';</span>
}], [_.matches({ member: 'default' }), <span class="fstat-no" title="function not covered" >function (d) {</span>
<span class="cstat-no" title="statement not covered" >    return 'import ' + d.alias + ' from \'' + d.moduleName + '\';';</span>
}], [defaultCase, <span class="fstat-no" title="function not covered" >function (d) {</span>
<span class="cstat-no" title="statement not covered" >    return 'import { ' + d.member + ' as ' + d.alias + ' } from \'' + d.moduleName + '\';';</span>
}]]);
&nbsp;
var buildImportES6 = _.cond([[isImportAsterisk, <span class="fstat-no" title="function not covered" >function (d) {</span>
<span class="cstat-no" title="statement not covered" >    return 'import * as ' + d.alias + ' from \'' + d.moduleName + '\';';</span>
}], [_.matches({ member: 'default' }), <span class="fstat-no" title="function not covered" >function (d) {</span>
<span class="cstat-no" title="statement not covered" >    return 'import ' + d.alias + ' from \'' + d.moduleName + '\';';</span>
}], [defaultCase, <span class="fstat-no" title="function not covered" >function (d) {</span>
<span class="cstat-no" title="statement not covered" >    return 'import { ' + d.member + ' as ' + d.alias + ' } from \'' + d.moduleName + '\';';</span>
...
&nbsp;
var buildImportCommonJS = _.cond([[isImportAsterisk, <span class="fstat-no" title="function not covered" >function (d) {</span>
<span class="cstat-no" title="statement not covered" >    return 'var ' + d.alias + ' = require(\'' + d.moduleName + '\');';</span>
}], [defaultCase, <span class="fstat-no" title="function not covered" >function (d) {</span>
<span class="cstat-no" title="statement not covered" >    return 'var ' + d.alias + ' = require(\'' + d.moduleName + '\').' + d.member + ';';</span>
}]]);
&nbsp;
var buildImport = {
